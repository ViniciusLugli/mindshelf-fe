        ...
        <div className="space-y-6">
          ...
          <div className="max-w-3xl space-y-3">
            ...
            <p className="max-w-2xl text-sm leading-relaxed text-base-content/58 sm:text-base">
              A home agora funciona como uma mesa editorial: respostas urgentes
              vem primeiro, o material de trabalho aparece logo depois e a sua
              rede fica por perto sem competir com o foco principal.
            </p>
          </div>
