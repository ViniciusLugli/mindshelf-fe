...
import type { HomeFriend } from "./home.types";
          ...
          friends.map((friend) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate font-semibold text-base-content">{friend.name}</p>
                <p className="truncate text-sm text-base-content/48">{friend.email}</p>
              </div>
            </Link>
          ))
        ) : (
