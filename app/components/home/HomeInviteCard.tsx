...
import type { HomeInvite } from "./home.types";
    ...
    <article className="rounded-[1.75rem] border border-base-300/60 bg-base-100/92 p-4 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="truncate font-semibold text-base-content">{invite.requester.name}</p>
          <p className="truncate text-sm text-base-content/48">{invite.requester.email}</p>
        </div>
      </div>
